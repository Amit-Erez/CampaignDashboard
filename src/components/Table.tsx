...
const Table = ({
  ...
  return (
    <div className="relative h-full min-h-0 min-w-0 overflow-hidden rounded-b-[20px] border border-gray-400">
      {visibleCampaigns.length === 0 && (
        <div className="absolute flex items-center justify-center top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 h-20 w-80 border border-gray-300 rounded-xl bg-white shadow-md z-20">
